...
(**62, 65, 67, 69**), `docs/spec/proposer.md` (**66, 67**) and `data/acceptance/rules.json` (**71, 72**).
`data/standards/room-constraints.json` is **back to a single claimant (72)** — 74 closed.

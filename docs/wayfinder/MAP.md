...
**Five** artifacts have more than one claimant, and the table below is the whole
...
(**62, 65, 67**), `docs/spec/proposer.md` (**66, 67**), `data/acceptance/rules.json` (**72, 76**),
`docs/research/room-area-bands.md` (**72, 76**) and `docs/spec/homeowner-surface.md`
(**45, 75**). `data/standards/room-constraints.json` has a **single claimant (72)** —
74, 69 and 71 all closed.

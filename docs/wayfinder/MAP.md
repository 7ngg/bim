...
(**62, 65, 67, 69**), `docs/spec/proposer.md` (**66, 67**), `data/acceptance/rules.json` (**71, 72**) and
`data/standards/room-constraints.json` (**71 is not on it; 72 and 74** — see below).

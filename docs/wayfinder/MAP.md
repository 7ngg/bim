...
order** — the done-test decides order. Live conflicts: `docs/spec/proposer.md`
(**63, 64**) and `experiments/warp/` (**62, 63, 64**). *(Ticket 59 closed and
declared `experiments/warp/`, which was unclaimed at the time; 64 is the ticket it
raised, and it re-widens both sets to three.)* *(The count said six and had

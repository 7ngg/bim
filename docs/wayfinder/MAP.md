...
(**62, 65, 67, 69**), `docs/spec/proposer.md` (**66, 67**), and — new with ticket 70's
close — `data/acceptance/rules.json` (**71, 72**) and
`data/standards/room-constraints.json` (**72, 73**).

...
(**62, 65, 67**), `docs/spec/proposer.md` (**66, 67**) and `data/acceptance/rules.json` (**71, 72**).
`data/standards/room-constraints.json` has a **single claimant (72)** — 74 and 69 both closed.

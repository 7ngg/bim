...
**One** artifact has more than one claimant, and the table below is the whole
write-set of the map, most of it historical. Read it as a **conflict map, not an
order** — the done-test decides order. Live conflict: `experiments/warp/`
(**62, 64, 65**). *(Ticket 59 closed and declared `experiments/warp/`, which was
...
65 is the ticket it raised, and it keeps `experiments/warp/` at three.)* *(The count said six and had
